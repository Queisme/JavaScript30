...
//Filter the list of inventors for any that died in the 1800's

const diedIn = inventors.filter(
  (inventor) => inventor.passed > 1799 && inventor.passed <= 1899
);

console.table(diedIn);
...
const peopleNames = people.sort((a, b) => (a > b ? 1 : -1));
